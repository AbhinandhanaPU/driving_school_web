...
import 'package:new_project_driving/view/users/admin/screens/courses/course_list/courses_data_list.dart';
...
class AllCoursesDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () {
        return
      courseController.ontapStudentDetail.value == true
          ?  StudentsInCoursesDetails()
